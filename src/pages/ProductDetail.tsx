...
const ProductDetail: React.FC = () => {
  ...
  if (isError || !product) return <Navigate to="/products" />;
    ...
    <div className="pt-24 sm:pt-32 pb-16 bg-white min-h-screen">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-20">
          ...
          <div className="space-y-2 sm:space-y-4">
            <div className="relative aspect-square sm:aspect-[3/4] overflow-hidden bg-gray-50 rounded-sm group/img cursor-zoom-in" onClick={() => openLightbox(activeImage)}>
              <img src={product.images[activeImage]} alt={product.name} className="w-full h-full object-cover transition-transform duration-500 group-hover/img:scale-105" />
              <button
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-xl sm:text-2xl font-bold mb-5 sm:mb-8">₦{product.price.toLocaleString('en-NG', { minimumFractionDigits: 2 })}</p>
            ...
            <div className="flex gap-3 mb-8 sm:mb-12">
              <Button onClick={handleAddToCart} className="flex-grow py-4 sm:py-5 text-xs sm:text-sm uppercase tracking-widest font-bold">
                Add to Cart
              </Button>
      ...
      {lightboxOpen && (
        <div className="fixed inset-0 z-[9998] bg-black/95 flex items-center justify-center" onClick={closeLightbox}>
          ...
          <img src={product.images[lightboxIndex]} alt={product.name} className="max-h-[90vh] max-w-[90vw] object-contain select-none" onClick={e => e.stopPropagation()} />
          {product.images.length > 1 && (
