          ...
          <div className="lg:col-span-7">
            <div className="bg-white p-8 shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full bg-green-500 hover:bg-green-600 text-white py-4 font-bold uppercase tracking-widest text-sm flex items-center justify-center gap-3 transition-colors"
                >
